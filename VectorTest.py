...
# Print all 3 numbers for all 3 vectors
print "v1 = " + str(v1)
print "v2 = " + str(v2)
print "v3 = " + str(v3)
print ""
...
Demonstrating result  v1 x v2 = -v2 x v1 
"""  
...
Demonstrating result v1 x (v2 + v3) and (v1 x v2) + (v1 x v3) 
"""  
...
Demonstrating result v1 x (v2 x v3) and (v1.v3)v2 - (v1.v2)v3 
"""  
